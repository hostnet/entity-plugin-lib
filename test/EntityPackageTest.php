...
class EntityPackageTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGetPackageContent()
    {
        ...
        $entity_package = new EntityPackage(new Package('hostnet/foo', 1.0, 1.0), $package_io);

...
class EntityPackageTest extends PHPUnit_Framework_TestCase
{
  ...
  public function testGetRequires()
  {
    ...
    $this->assertEquals(array($link), $entity_package->getRequires());
  }
  ...
  public function testAddRequiredPackage()
  {
    ...
    $this->assertEquals(array($child_a, $child_b), $entity_package->getRequiredPackages());
  }
  ...
  public function testAddDependentPackage()
  {
    ...
    $this->assertEquals(array($parent_a, $parent_b), $entity_package->getDependentPackages());
  }
}
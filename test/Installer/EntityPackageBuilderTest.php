...
class EntityPackageBuilderTest extends PHPUnit_Framework_TestCase
{
  ...
  public function addsDependenciesProvider()
  {
    ...
    $bar->setRequires(array(new Link('hostnet/bar', 'hostnet/foo')));

    return array(
        array(array(), array(), array()),
        array(array($foo), array('hostnet/foo' => array()), array('hostnet/foo' => array())),
        array(array($foo, $bar), array('hostnet/foo' => array(), 'hostnet/bar' => array($foo)), array('hostnet/foo' => array($bar), 'hostnet/bar' => array()))
    );
  }
